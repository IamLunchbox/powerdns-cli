...
class MockUtils:
    ...
    def mock_http_get(self, status_code: int, json_output: dict = None, text_output: str = '') -> unittest_MagicMock:
    ...
    def mock_http_put(self, status_code: int, json_output: dict = {}, text_output: str = '') -> unittest_MagicMock:
